...
fig = imagesc(1:Ny,1:Nx/2,Bnorm);
fig_part = plot(ye(part_number), xe(part_number), 'ro', 'MarkerSize', 30);
...
for a = 1:last_number,
    ...
    set(fig_part, 'Ydata', xe(part_number));
    set(fig_part, 'Xdata', ye(part_number));
    f = getframe(gcf);
