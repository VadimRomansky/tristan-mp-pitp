...
legend('10rg 1','10rg 2','10rg 3','10rg 4','10rg 5','10rg 6','10rg 7','10rg 8','5rg 1','5rg 2','5rg 3','5rg 4','5rg 5','5rg 6','5rg 7','5rg 8','2rg 1','2rg 2','2rg 3','2rg 4','2rg 5','2rg 6','2rg 7','2rg 8','Location','southeast');
...
%plot (Pp(j, 1:Np),Fpjuttner(1:Np),'color','green');
legend('10rg 1','10rg 2','10rg 3','10rg 4','10rg 5','10rg 6','10rg 7','10rg 8','5rg 1','5rg 2','5rg 3','5rg 4','5rg 5','5rg 6','5rg 7','5rg 8','2rg 1','2rg 2','2rg 3','2rg 4','2rg 5','2rg 6','2rg 7','2rg 8', LegendTitle{2},'Location','southeast');
%legend(LegendTitle{1}, LegendTitle{2},'juttner','Location','southeast');
grid ;
